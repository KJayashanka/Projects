...
echo "<td style='border: 0px'><input type=text name=firstname size=35></td></tr>";
echo "<tr><td style='border: 0px'>*Last Name </td>";
echo "<td style='border: 0px'><input type=text name=lastname size=35></td></tr>";
...
echo "<td style='border: 0px'><input type=password name=password1 maxlength=10 size=35></td></tr>";
